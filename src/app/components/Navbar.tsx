...
import {cilX, cilHamburgerMenu} from '@coreui/icons';
        ...
        <div className='flex items-center justify-between h-16'>
            <div className='flex items-center'>
               <div className='flex-shrink-0'>
                <a href='/' className='text-white'>EPOCINFO</a>
                </div> 
            </div>
            <div className='hidden md:block'>
                <div className='ml-4 flex items-center space-x-4'>
                    ...
                    <a href='/' className='text-white hover:bg-white hover:text-black rounded-lg p-2'>Careers</a>

                </div>
            </div>
            <div className='md:hidden flex items-center'>
                <button onClick={toggleNavbar} className='inline-flex items-center justify-center p-2 rounded-md text-white md:text-white hover:text-white focus:outline-none focus:ring-2 focus:ring-inset focus:ring-white'>
                    {isClicked ? (
                        <svg
                        className='h-6 w-6'
...
<a href='/' className='text-white block hover:bg-white hover:text-black rounded-lg p-2'>Careers</a>
    </div>  
  </div>  
)}
 </nav>
